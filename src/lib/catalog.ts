...
const MUTATE_SLUG_RX = /(?:^|_)(?:SEND|CREATE|UPDATE|ADD|REMOVE|MODIFY|DELETE|TRASH|ARCHIVE|REPLY|FORWARD|MOVE|INSERT|APPLY|MARK_AS|CLOSE|CANCEL|LOCK|TRANSFER|UPLOAD|BATCH|STAR|UNSTAR|PATCH|IMPORT|WATCH|DUPLICATE|COPY|EDIT|EMPTY)(?:_|$)/;
...
const EMAIL_READ_DENY =
  /(?:^|_)(?:ADD|SEND|DELETE|TRASH|ARCHIVE|MODIFY|UPDATE|DRAFT|REPLY|FORWARD|BATCH|MARK|MOVE|STAR|UNSTAR|LABEL|CREATE|INSERT|PATCH|REMOVE|EMPTY|CLEAR|DUPLICATE|COPY|EDIT|APPLY|IMPORT|WATCH|UPLOAD)(?:_|$)/;
